...
(async () => {
  ...
  await fs.writeFile("cicatricial-pemphigoid-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cicatricial-pemphigoid-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
